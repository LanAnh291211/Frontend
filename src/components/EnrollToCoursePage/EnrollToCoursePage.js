...
class EnrollToCoursePage extends Component{
    ...
    applyAuthentication(){
        ...
        return new Promise((resolve,reject)=>{
            ...
            if(courseDataError){
                this.setErrors({courseError: "Ít nhất 1 lớp phải được chọn"})
            }
            ...
            if(studentImage === undefined){
                this.setErrors({fileError: "Tải lên một file"})
            }
            resolve();
        })
    }
                ...
                <div className="MainBody Enroll_MainBody sidePage">
                    <div className="Container Enroll_Container">
                        <div className="FormContainer Enroll_FormContainer">
                            <header>
                                <h1>
                                    Ghi danh<span>({this.props.students[0].roll_no})</span>
                                </h1>
                            </header>
