                ...
                <div className="Container">
                    <div className="FormContainer">
                        ...
                        <form onSubmit={this.onSubmit}>
                            ...
                            <div>
                                <label className="Label" htmlFor="department">Bộ phận</label>
                            ...
                            <div>
                                <label className="Label" htmlFor="teacher">Giáo viên giảng dạy</label>
                                <div className="selectDiv">
                                    <select 
                                        id="teacherAssigned"
                                        name="teacher"
                            ...
                            <div>
                                <label className="Label" htmlFor="semester">Học kì</label>
                                <div className="selectDiv">
                                    <select 
                                        id="semester"
                                        name="semester"
