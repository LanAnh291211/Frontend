...
class AttendancePage extends Component{
    ...
    //create setTodaysAttendance function
  



    setTodaysAttendance = () => {
       // if this.state.data.courseData.name == null then show notifcation 
            // that no course is selected
        ...
        // if( this.state.data.courseData.name == undefined ) this.props.setCourses({
        //     // if we dont pass any filter then it will fetch all the courses
        //     // but we only want the courses of the teacher
        //     // if currentCourseName == null then show notifcation 
        //     // that no course is selected
        ...
        this.props.setCourses({
            ...
            //  "name": this.state.data.courseData.name 
        }) 
